...
async def homework_coach(
    ...
    system_prompt = (
        ...
        "קראי את השאלה הפעילה ואת חומר המקור, הביני מה צריך למצוא, ולמדי את הילד בצורה טבעית שלב אחרי שלב. "
