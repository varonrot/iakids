-- ROLLBACK of 20260910_game_bank_one_call.sql  ·  2026-09-17
--
...
drop function if exists public.game_record_answer(uuid, text, text, boolean, int, smallint, uuid, jsonb, text);
