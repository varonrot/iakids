...
`;
  ...
  const HOMEWORK_HELP_MODE_PROMPTS = {
    understand_question: `
...
`
  ...
  function getChoiceInstruction(choiceId){
    switch(choiceId){
      ...
      case "solve_together":
        return HOMEWORK_HELP_MODE_PROMPTS.solve_together;
      case "check_answer":
        return HOMEWORK_HELP_MODE_PROMPTS.check_answer;
      default:
      ...
      const response = await fetch(
        `${TUTOR_API_BASE}/api/tutor/homework-turn`,
        {
          ...
          body: JSON.stringify({
            ...
            help_mode: window.HOMEWORK_HELP_MODE || null,
